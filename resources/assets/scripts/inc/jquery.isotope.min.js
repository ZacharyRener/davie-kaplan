...
!(function (t, e) {
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define("isotopeMB/js/item", ["outlayer/outlayer"], e)
      : "object" == typeof module && module.exports
      ? (module.exports = e(require("outlayer")))
      : ((t.IsotopeMB = t.IsotopeMB || {}), (t.IsotopeMB.Item = e(t.Outlayer)));
  })(window, function (t) {
    "use strict";
    function e() {
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ...
      : ((t.IsotopeMB = t.IsotopeMB || {}),
        (t.IsotopeMB.LayoutMode = e(t.getSize, t.Outlayer)));
  })(window, function (t, e) {
    "use strict";
    function i(t) {
      (this.isotopeMB = t),
    ...
    return (
      o.forEach(function (t) {
        n[t] = function () {
          return e.prototype[t].apply(this.isotopeMB, arguments);
        };
      }),
      (n.needsVerticalResizeLayout = function () {
        var e = t(this.isotopeMB.element),
          i = this.isotopeMB.size && e;
        return i && e.innerHeight != this.isotopeMB.size.innerHeight;
      }),
      ...
      (n.getSegmentSize = function (t, e) {
        ...
        if ((this._getMeasurement(i, n), !this[i])) {
          ...
          this[i] = (o && o[n]) || this.isotopeMB.size["inner" + e];
        }
      }),
      (n.getFirstItemSize = function () {
        var e = this.isotopeMB.filteredItems[0];
      ...
      (n.getSize = function () {
        this.isotopeMB.getSize(), (this.size = this.isotopeMB.size);
      }),
      (i.modes = {}),
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ...
      : e(t.IsotopeMB.LayoutMode, t.Masonry);
  })(window, function (t, e) {
    "use strict";
    var i = t.create("masonry"),
      n = i.prototype,
    ...
    n.measureColumns = function () {
      (this.items = this.isotopeMB.filteredItems), r.call(this);
    };
    var a = n._getOption;
    return (
      (n._getOption = function (t) {
        return "fitWidth" == t
          ...
          : a.apply(this.isotopeMB, arguments);
      }),
      i
    );
  }),
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define("isotopeMB/js/layout-modes/fit-rows", ["../layout-mode"], e)
      : "object" == typeof exports
      ? (module.exports = e(require("../layout-mode")))
      : e(t.IsotopeMB.LayoutMode);
  })(window, function (t) {
    "use strict";
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define("isotopeMB/js/layout-modes/vertical", ["../layout-mode"], e)
      : "object" == typeof module && module.exports
      ? (module.exports = e(require("../layout-mode")))
      : e(t.IsotopeMB.LayoutMode);
  })(window, function (t) {
    ...
    return (
      ...
      (i._getItemLayoutPosition = function (t) {
        t.getSize();
        var e =
            (this.isotopeMB.size.innerWidth - t.size.outerWidth) *
